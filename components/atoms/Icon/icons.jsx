...
export const IconDefinitions = {
    ...
    marketing: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 11 18-5v12L3 14v-3z"></path><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"></path></svg>,
    ...
    logo: (
         <svg width="154" height="64" viewBox="0 0 154 64" xmlns="http://www.w3.org/2000/svg">
            <style>{`.orcaflow-title { font-family: 'Manrope', sans-serif; font-size: 32px; font-weight: 700; fill: #484A6A; } .orcaflow-tagline { font-family: 'Manrope', sans-serif; font-size: 14px; font-weight: 500; fill: #484A6A; }`}</style>
            <g>
                <path d="M91.5 6 L 106.5 19 L 126.5 4 L 141.5 14 L 151.5 6" stroke="#F5D547" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="91.5" cy="6" r="4" fill="#F5D547"/>
                <circle cx="106.5" cy="19" r="4" fill="#F5D547"/>
                <circle cx="126.5" cy="4" r="4" fill="#F5D547"/>
                <circle cx="141.5" cy="14" r="4" fill="#F5D547"/>
                <circle cx="151.5" cy="6" r="4" fill="#F5D547"/>
            </g>
            <text x="0" y="40" className="orcaflow-title">OrcaFlow</text>
            <text x="0" y="60" className="orcaflow-tagline">AI Automation</text>
        </svg>
    ),
     logoMark: (
        <svg width="40" height="40" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
            <g transform="scale(0.4) translate(-80 -2)">
                <path d="M91.5 6 L 106.5 19 L 126.5 4 L 141.5 14 L 151.5 6" stroke="#F5D547" strokeWidth="6" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="91.5" cy="6" r="8" fill="#F5D547"/>
                <circle cx="106.5" cy="19" r="8" fill="#F5D547"/>
                <circle cx="126.5" cy="4" r="8" fill="#F5D547"/>
                <circle cx="141.5" cy="14" r="8" fill="#F5D547"/>
                <circle cx="151.5" cy="6" r="8" fill="#F5D547"/>
            </g>
        </svg>
    ),
    sidebarToggle: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>,
    attachment: <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"></path></svg>,
    ...
    history: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8v4l3 3"></path><circle cx="12" cy="12" r="10"></circle></svg>,
    ...
    send: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>,
    userPlus: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><line x1="23" y1="11" x2="17" y2="11"></line><line x1="20" y1="8" x2="20" y2="14"></line></svg>,
    ...
    facebook: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#1877F2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>,
    instagram: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#E1306C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>,
    linkedin: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#0A66C2" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>,
...
export const Icon = ({ name, ...props }) => {
    ...
    if (!IconComponent) {
        // Return null or a placeholder for unknown icons
        console.warn(`Icon "${name}" not found.`);
        return null;
    }

    // Clone the element to apply any additional props like style, className, etc.
